...
div=3//2 #our result will be an int, rounds down!
print("3/2==",division)
print("3//2==",div)
power=2**5 # is basically 2^5=32
mod=10%3 #prints remainder, in this case 10%3==1
print("2**5==",power)
...
print(name[3:7]) #prints heri

name="Catherine"
name[0]="K"
print(name) # this would raise an error because you can't change the elements

#but you can do this:
name+=" sucks"
print(name) #prints out Catherine sucks

#if you really want to change the element, you can assign it to a new string
#this isnt ideal since we are taking up memory with this
new_name= nam[1:]
new_name= "K"+ new_name
print(new_name)